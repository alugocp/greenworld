...
class CollectionIwebXlsxCase(unittest.TestCase):
    ...
    def test_parse_csv_line(self):
        self.assertEqual(iweb_xls.parse_csv_line('hello,1, 2,  bye'), ['hello', '1', '2', 'bye'])
        self.assertEqual(iweb_xls.parse_csv_line('"hello there",1,2,bye'), ['hello there', '1', '2', 'bye'])
        self.assertEqual(iweb_xls.parse_csv_line('"hello there"   ,"good bye"'), ['hello there', 'good bye'])
    ...
    def test_transposed(self):
        ...
        self.assertEqual(iweb_xls.transposed([[1, 2, 3], [4, 5, 6]]), [[1, 4], [2, 5], [3, 6]])
