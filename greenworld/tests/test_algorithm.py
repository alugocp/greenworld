...
class AlgorithmCase(unittest.TestCase):
    ...
    def test_environment(self):
        ...
        self.assertEqual(
            ...
            Factor(
                -1.0,
                "mismatched soil type and mismatched soil drainage and mismatched soil pH",
            ),
        )
    ...
    def test_sunlight(self):
                ...
                DotDict(
                    {
                        "name": "P2",
                        "sun": Sun.FULL_SUN,
                        "growth_habit": GrowthHabit.SUBSHRUB,
                    }
                ),
                Factor(-1.0, "P2 may shade out P1"),
            ],
                ...
                DotDict(
                    {
                        "name": "P2",
                        "sun": Sun.FULL_SUN,
                        "growth_habit": GrowthHabit.GRAMINOID,
                    }
                ),
                None,
            ],
                ...
                DotDict(
                    {
                        "name": "P2",
                        "sun": Sun.FULL_SUN,
                        "growth_habit": GrowthHabit.LICHENOUS,
                    }
                ),
                None,
            ],
                ...
                DotDict(
                    {
                        "name": "P2",
                        "sun": Sun.FULL_SUN,
                        "growth_habit": GrowthHabit.NONVASCULAR,
                    }
                ),
                None,
            ],
        ...
        rule = SunlightRule()
        for pair in data:
            self.assertEqual(rule.generate_factor(None, pair[0], pair[1]), pair[2])
